...
public class GetInfoOptions implements org.apache.thrift.TBase<GetInfoOptions, GetInfoOptions._Fields>, java.io.Serializable, Cloneable, Comparable<GetInfoOptions> {
   ...
   * @see NumErrorsChoice
   */
  public NumErrorsChoice num_err_choice; // optional
   ...
   * @see NumErrorsChoice
   */
  public NumErrorsChoice getNum_err_choice() {
   ...
   * @see NumErrorsChoice
   */
  public GetInfoOptions setNum_err_choice(NumErrorsChoice num_err_choice) {
    this.num_err_choice = num_err_choice;
    return this;
  }

  public void unsetNum_err_choice() {
    this.num_err_choice = null;
  }

  /** Returns true if field num_err_choice is set (has been assigned a value) and false otherwise */
  public boolean isSetNum_err_choice() {
    return this.num_err_choice != null;
  }

  public void setNum_err_choiceIsSet(boolean value) {
    if (!value) {
      this.num_err_choice = null;
    }
  }
  ...
  public void setFieldValue(_Fields field, java.lang.Object value) {
    ...
    case NUM_ERR_CHOICE:
      if (value == null) {
        ...
        setNum_err_choice((NumErrorsChoice)value);
      }
      break;
  ...
  public boolean equals(GetInfoOptions that) {
    ...
    boolean this_present_num_err_choice = true && this.isSetNum_err_choice();
    boolean that_present_num_err_choice = true && that.isSetNum_err_choice();
  ...
  public int hashCode() {
    ...
    hashCode = hashCode * 8191 + ((isSetNum_err_choice()) ? 131071 : 524287);
    if (isSetNum_err_choice())
  ...
  public int compareTo(GetInfoOptions other) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetNum_err_choice()).compareTo(other.isSetNum_err_choice());
    if (lastComparison != 0) {
        ...
        switch (schemeField.id) {
          case 1: // NUM_ERR_CHOICE
            if (schemeField.type == org.apache.thrift.protocol.TType.I32) {
              ...
              struct.setNum_err_choiceIsSet(true);
            } else { 
