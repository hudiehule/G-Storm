...
public class LogConfig implements org.apache.thrift.TBase<LogConfig, LogConfig._Fields>, java.io.Serializable, Cloneable, Comparable<LogConfig> {
  ...
  public java.util.Map<java.lang.String,LogLevel> named_logger_level; // optional
  ...
  public LogConfig(LogConfig other) {
    if (other.isSetNamed_logger_level()) {
  ...
  public int getNamed_logger_levelSize() {
    return (this.named_logger_level == null) ? 0 : this.named_logger_level.size();
  }

  public void putToNamed_logger_level(java.lang.String key, LogLevel val) {
  ...
  public java.util.Map<java.lang.String,LogLevel> getNamed_logger_level() {
    return this.named_logger_level;
  }

  public LogConfig setNamed_logger_level(java.util.Map<java.lang.String,LogLevel> named_logger_level) {
    this.named_logger_level = named_logger_level;
    return this;
  }

  public void unsetNamed_logger_level() {
    this.named_logger_level = null;
  }

  /** Returns true if field named_logger_level is set (has been assigned a value) and false otherwise */
  public boolean isSetNamed_logger_level() {
    return this.named_logger_level != null;
  }

  public void setNamed_logger_levelIsSet(boolean value) {
    if (!value) {
      this.named_logger_level = null;
    }
  }
  ...
  public void setFieldValue(_Fields field, java.lang.Object value) {
    ...
    case NAMED_LOGGER_LEVEL:
      if (value == null) {
        unsetNamed_logger_level();
      } else {
        setNamed_logger_level((java.util.Map<java.lang.String,LogLevel>)value);
      }
      break;
  ...
  public boolean isSet(_Fields field) {
    ...
    switch (field) {
    case NAMED_LOGGER_LEVEL:
      return isSetNamed_logger_level();
    }
    throw new java.lang.IllegalStateException();
  }
  ...
  public boolean equals(LogConfig that) {
    ...
    boolean this_present_named_logger_level = true && this.isSetNamed_logger_level();
    boolean that_present_named_logger_level = true && that.isSetNamed_logger_level();
  ...
  public int hashCode() {
    ...
    hashCode = hashCode * 8191 + ((isSetNamed_logger_level()) ? 131071 : 524287);
    if (isSetNamed_logger_level())
  ...
  public int compareTo(LogConfig other) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetNamed_logger_level()).compareTo(other.isSetNamed_logger_level());
    if (lastComparison != 0) {
  ...
  private static class LogConfigStandardScheme extends org.apache.thrift.scheme.StandardScheme<LogConfig> {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.named_logger_level = new java.util.HashMap<java.lang.String,LogLevel>(2*_map774.size);
                java.lang.String _key775;
                LogLevel _val776;
              ...
              struct.setNamed_logger_levelIsSet(true);
            } else { 
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, LogConfig struct) throws org.apache.thrift.TException {
      ...
      if (struct.named_logger_level != null) {
        if (struct.isSetNamed_logger_level()) {
          oprot.writeFieldBegin(NAMED_LOGGER_LEVEL_FIELD_DESC);
          {
            ...
            for (java.util.Map.Entry<java.lang.String, LogLevel> _iter778 : struct.named_logger_level.entrySet())
            {
      ...
      if (struct.isSetNamed_logger_level()) {
        {
          ...
          for (java.util.Map.Entry<java.lang.String, LogLevel> _iter779 : struct.named_logger_level.entrySet())
          {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.named_logger_level = new java.util.HashMap<java.lang.String,LogLevel>(2*_map780.size);
          java.lang.String _key781;
          LogLevel _val782;
