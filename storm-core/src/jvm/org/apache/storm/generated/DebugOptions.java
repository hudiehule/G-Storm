...
public class DebugOptions implements org.apache.thrift.TBase<DebugOptions, DebugOptions._Fields>, java.io.Serializable, Cloneable, Comparable<DebugOptions> {
  ...
  public void setFieldValue(_Fields field, java.lang.Object value) {
    ...
    case SAMPLINGPCT:
      if (value == null) {
        ...
        setSamplingpct((java.lang.Double)value);
      }
      break;
  ...
  public int hashCode() {
    ...
    hashCode = hashCode * 8191 + ((isSetSamplingpct()) ? 131071 : 524287);
    if (isSetSamplingpct())
  ...
  public int compareTo(DebugOptions other) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetSamplingpct()).compareTo(other.isSetSamplingpct());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetSamplingpct()) {
