...
public class ExecutorSpecificStats extends org.apache.thrift.TUnion<ExecutorSpecificStats, ExecutorSpecificStats._Fields> {
  ...
  static {
    ...
    tmpMap.put(_Fields.GPU_BOLT, new org.apache.thrift.meta_data.FieldMetaData("gpu_bolt", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
        new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, GPUBoltStats.class)));
  ...
  public static ExecutorSpecificStats gpu_bolt(GPUBoltStats value) {
    ExecutorSpecificStats x = new ExecutorSpecificStats();
    x.setGpu_bolt(value);
    return x;
  }
  ...
  protected void checkType(_Fields setField, java.lang.Object value) throws java.lang.ClassCastException {
    switch (setField) {
      ...
      case GPU_BOLT:
        if (value instanceof GPUBoltStats) {
          break;
        }
        throw new java.lang.ClassCastException("Was expecting value of type GPUBoltStats for field 'gpu_bolt', but got " + value.getClass().getSimpleName());
      default:
      ...
      switch (setField) {
        ...
        case GPU_BOLT:
          if (field.type == GPU_BOLT_FIELD_DESC.type) {
            GPUBoltStats gpu_bolt;
            gpu_bolt = new GPUBoltStats();
            gpu_bolt.read(iprot);
            return gpu_bolt;
          } else {
            org.apache.thrift.protocol.TProtocolUtil.skip(iprot, field.type);
  ...
  protected void standardSchemeWriteValue(org.apache.thrift.protocol.TProtocol oprot) throws org.apache.thrift.TException {
    switch (setField_) {
      ...
      case SPOUT:
        ...
        return;
      case GPU_BOLT:
        GPUBoltStats gpu_bolt = (GPUBoltStats)value_;
  ...
  public GPUBoltStats getGpu_bolt() {
    if (getSetField() == _Fields.GPU_BOLT) {
      return (GPUBoltStats)getFieldValue();
    } else {
  ...
  public void setGpu_bolt(GPUBoltStats value) {
    if (value == null) throw new java.lang.NullPointerException();
