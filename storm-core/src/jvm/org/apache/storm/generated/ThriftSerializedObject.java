...
public class ThriftSerializedObject implements org.apache.thrift.TBase<ThriftSerializedObject, ThriftSerializedObject._Fields>, java.io.Serializable, Cloneable, Comparable<ThriftSerializedObject> {
  ...
  public java.nio.ByteBuffer bits; // required
  ...
  public ThriftSerializedObject setName(java.lang.String name) {
    this.name = name;
    return this;
  }
  ...
  public byte[] getBits() {
    setBits(org.apache.thrift.TBaseHelper.rightSize(bits));
    return bits == null ? null : bits.array();
  }

  public java.nio.ByteBuffer bufferForBits() {
    return org.apache.thrift.TBaseHelper.copyBinary(bits);
  }

  public ThriftSerializedObject setBits(byte[] bits) {
    this.bits = bits == null ? (java.nio.ByteBuffer)null : java.nio.ByteBuffer.wrap(bits.clone());
    return this;
  }

  public ThriftSerializedObject setBits(java.nio.ByteBuffer bits) {
    this.bits = org.apache.thrift.TBaseHelper.copyBinary(bits);
    return this;
  }
    ...
    case BITS:
      if (value == null) {
        ...
        if (value instanceof byte[]) {
          ...
          setBits((java.nio.ByteBuffer)value);
        }
      }
      break;
  ...
  public boolean equals(ThriftSerializedObject that) {
    ...
    boolean this_present_bits = true && this.isSetBits();
    boolean that_present_bits = true && that.isSetBits();
  ...
  public int hashCode() {
    ...
    hashCode = hashCode * 8191 + ((isSetBits()) ? 131071 : 524287);
    if (isSetBits())
  ...
  public int compareTo(ThriftSerializedObject other) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetBits()).compareTo(other.isSetBits());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetBits()) {
  ...
  public void validate() throws org.apache.thrift.TException {
    ...
    if (bits == null) {
      throw new org.apache.thrift.protocol.TProtocolException("Required field 'bits' was not present! Struct: " + toString());
    }
