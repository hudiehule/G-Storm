...
public class ShellComponent implements org.apache.thrift.TBase<ShellComponent, ShellComponent._Fields>, java.io.Serializable, Cloneable, Comparable<ShellComponent> {
  ...
  public java.lang.String execution_command; // required
  ...
  public ShellComponent(ShellComponent other) {
    if (other.isSetExecution_command()) {
  ...
  public java.lang.String getExecution_command() {
    return this.execution_command;
  }

  public ShellComponent setExecution_command(java.lang.String execution_command) {
    this.execution_command = execution_command;
    return this;
  }

  public void unsetExecution_command() {
    this.execution_command = null;
  }

  /** Returns true if field execution_command is set (has been assigned a value) and false otherwise */
  public boolean isSetExecution_command() {
    return this.execution_command != null;
  }

  public void setExecution_commandIsSet(boolean value) {
    if (!value) {
      this.execution_command = null;
    }
  }
  ...
  public ShellComponent setScript(java.lang.String script) {
    this.script = script;
    return this;
  }
  ...
  public void setFieldValue(_Fields field, java.lang.Object value) {
    ...
    case EXECUTION_COMMAND:
      if (value == null) {
        unsetExecution_command();
      } else {
        setExecution_command((java.lang.String)value);
      }
      break;
  ...
  public boolean equals(ShellComponent that) {
    ...
    boolean this_present_execution_command = true && this.isSetExecution_command();
    boolean that_present_execution_command = true && that.isSetExecution_command();
  ...
  public int hashCode() {
    ...
    hashCode = hashCode * 8191 + ((isSetExecution_command()) ? 131071 : 524287);
    if (isSetExecution_command())
  ...
  public int compareTo(ShellComponent other) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetExecution_command()).compareTo(other.isSetExecution_command());
    if (lastComparison != 0) {
        ...
        switch (schemeField.id) {
          case 1: // EXECUTION_COMMAND
            if (schemeField.type == org.apache.thrift.protocol.TType.STRING) {
              ...
              struct.setExecution_commandIsSet(true);
            } else { 
  ...
  private static class ShellComponentTupleScheme extends org.apache.thrift.scheme.TupleScheme<ShellComponent> {
    ...
    public void write(org.apache.thrift.protocol.TProtocol prot, ShellComponent struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetExecution_command()) {
        optionals.set(0);
      }
