...
public class LSApprovedWorkers implements org.apache.thrift.TBase<LSApprovedWorkers, LSApprovedWorkers._Fields>, java.io.Serializable, Cloneable, Comparable<LSApprovedWorkers> {
  ...
  public java.util.Map<java.lang.String,java.lang.Integer> approved_workers; // required
  ...
  public LSApprovedWorkers(LSApprovedWorkers other) {
    if (other.isSetApproved_workers()) {
  ...
  public int getApproved_workersSize() {
    return (this.approved_workers == null) ? 0 : this.approved_workers.size();
  }

  public void putToApproved_workers(java.lang.String key, int val) {
  ...
  public java.util.Map<java.lang.String,java.lang.Integer> getApproved_workers() {
    return this.approved_workers;
  }

  public LSApprovedWorkers setApproved_workers(java.util.Map<java.lang.String,java.lang.Integer> approved_workers) {
    this.approved_workers = approved_workers;
    return this;
  }

  public void unsetApproved_workers() {
    this.approved_workers = null;
  }

  /** Returns true if field approved_workers is set (has been assigned a value) and false otherwise */
  public boolean isSetApproved_workers() {
    return this.approved_workers != null;
  }

  public void setApproved_workersIsSet(boolean value) {
    if (!value) {
      this.approved_workers = null;
    }
  }
  ...
  public void setFieldValue(_Fields field, java.lang.Object value) {
    ...
    case APPROVED_WORKERS:
      if (value == null) {
        unsetApproved_workers();
      } else {
        setApproved_workers((java.util.Map<java.lang.String,java.lang.Integer>)value);
      }
      break;
  ...
  public boolean equals(LSApprovedWorkers that) {
    ...
    boolean this_present_approved_workers = true && this.isSetApproved_workers();
    boolean that_present_approved_workers = true && that.isSetApproved_workers();
  ...
  public int hashCode() {
    ...
    hashCode = hashCode * 8191 + ((isSetApproved_workers()) ? 131071 : 524287);
    if (isSetApproved_workers())
  ...
  public int compareTo(LSApprovedWorkers other) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetApproved_workers()).compareTo(other.isSetApproved_workers());
    if (lastComparison != 0) {
  ...
  public void validate() throws org.apache.thrift.TException {
    ...
    if (approved_workers == null) {
      throw new org.apache.thrift.protocol.TProtocolException("Required field 'approved_workers' was not present! Struct: " + toString());
    }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.approved_workers = new java.util.HashMap<java.lang.String,java.lang.Integer>(2*_map722.size);
                java.lang.String _key723;
                int _val724;
              ...
              struct.setApproved_workersIsSet(true);
            } else { 
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, LSApprovedWorkers struct) throws org.apache.thrift.TException {
      ...
      if (struct.approved_workers != null) {
        oprot.writeFieldBegin(APPROVED_WORKERS_FIELD_DESC);
        {
          ...
          for (java.util.Map.Entry<java.lang.String, java.lang.Integer> _iter726 : struct.approved_workers.entrySet())
          {
  ...
  private static class LSApprovedWorkersTupleScheme extends org.apache.thrift.scheme.TupleScheme<LSApprovedWorkers> {
    ...
    public void write(org.apache.thrift.protocol.TProtocol prot, LSApprovedWorkers struct) throws org.apache.thrift.TException {
      org.apache.thrift.protocol.TTupleProtocol oprot = (org.apache.thrift.protocol.TTupleProtocol) prot;
      {
        ...
        for (java.util.Map.Entry<java.lang.String, java.lang.Integer> _iter727 : struct.approved_workers.entrySet())
        {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, LSApprovedWorkers struct) throws org.apache.thrift.TException {
      org.apache.thrift.protocol.TTupleProtocol iprot = (org.apache.thrift.protocol.TTupleProtocol) prot;
      {
        ...
        struct.approved_workers = new java.util.HashMap<java.lang.String,java.lang.Integer>(2*_map728.size);
        java.lang.String _key729;
        int _val730;
