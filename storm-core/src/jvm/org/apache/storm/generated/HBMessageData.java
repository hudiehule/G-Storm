...
public class HBMessageData extends org.apache.thrift.TUnion<HBMessageData, HBMessageData._Fields> {
  ...
  public static HBMessageData message_blob(java.nio.ByteBuffer value) {
    HBMessageData x = new HBMessageData();
    x.setMessage_blob(value);
    return x;
  }

  public static HBMessageData message_blob(byte[] value) {
    HBMessageData x = new HBMessageData();
    x.setMessage_blob(java.nio.ByteBuffer.wrap(value.clone()));
    return x;
  }
  ...
  public void setPulse(HBPulse value) {
    if (value == null) throw new java.lang.NullPointerException();
  ...
  public void setRecords(HBRecords value) {
    if (value == null) throw new java.lang.NullPointerException();
    setField_ = _Fields.RECORDS;
    value_ = value;
  }

  public HBNodes getNodes() {
  ...
  public void setNodes(HBNodes value) {
    if (value == null) throw new java.lang.NullPointerException();
    setField_ = _Fields.NODES;
    value_ = value;
  }

  public byte[] getMessage_blob() {
    setMessage_blob(org.apache.thrift.TBaseHelper.rightSize(bufferForMessage_blob()));
    java.nio.ByteBuffer b = bufferForMessage_blob();
    return b == null ? null : b.array();
  }

  public java.nio.ByteBuffer bufferForMessage_blob() {
  ...
  public void setMessage_blob(byte[] value) {
    setMessage_blob(java.nio.ByteBuffer.wrap(value.clone()));
  }

  public void setMessage_blob(java.nio.ByteBuffer value) {
    if (value == null) throw new java.lang.NullPointerException();
  ...
  public boolean isSetMessage_blob() {
