...
public class LocalStateData implements org.apache.thrift.TBase<LocalStateData, LocalStateData._Fields>, java.io.Serializable, Cloneable, Comparable<LocalStateData> {
  ...
  public java.util.Map<java.lang.String,ThriftSerializedObject> serialized_parts; // required
  ...
  public LocalStateData(LocalStateData other) {
    if (other.isSetSerialized_parts()) {
  ...
  public int getSerialized_partsSize() {
    return (this.serialized_parts == null) ? 0 : this.serialized_parts.size();
  }

  public void putToSerialized_parts(java.lang.String key, ThriftSerializedObject val) {
  ...
  public java.util.Map<java.lang.String,ThriftSerializedObject> getSerialized_parts() {
    return this.serialized_parts;
  }

  public LocalStateData setSerialized_parts(java.util.Map<java.lang.String,ThriftSerializedObject> serialized_parts) {
    this.serialized_parts = serialized_parts;
    return this;
  }

  public void unsetSerialized_parts() {
    this.serialized_parts = null;
  }

  /** Returns true if field serialized_parts is set (has been assigned a value) and false otherwise */
  public boolean isSetSerialized_parts() {
    return this.serialized_parts != null;
  }

  public void setSerialized_partsIsSet(boolean value) {
    if (!value) {
      this.serialized_parts = null;
    }
  }
  ...
  public void setFieldValue(_Fields field, java.lang.Object value) {
    ...
    case SERIALIZED_PARTS:
      if (value == null) {
        unsetSerialized_parts();
      } else {
        setSerialized_parts((java.util.Map<java.lang.String,ThriftSerializedObject>)value);
      }
      break;
  ...
  public boolean equals(LocalStateData that) {
    ...
    boolean this_present_serialized_parts = true && this.isSetSerialized_parts();
    boolean that_present_serialized_parts = true && that.isSetSerialized_parts();
  ...
  public int hashCode() {
    ...
    hashCode = hashCode * 8191 + ((isSetSerialized_parts()) ? 131071 : 524287);
    if (isSetSerialized_parts())
  ...
  public int compareTo(LocalStateData other) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetSerialized_parts()).compareTo(other.isSetSerialized_parts());
    if (lastComparison != 0) {
  ...
  public void validate() throws org.apache.thrift.TException {
    ...
    if (serialized_parts == null) {
      throw new org.apache.thrift.protocol.TProtocolException("Required field 'serialized_parts' was not present! Struct: " + toString());
    }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.serialized_parts = new java.util.HashMap<java.lang.String,ThriftSerializedObject>(2*_map704.size);
                java.lang.String _key705;
              ...
              struct.setSerialized_partsIsSet(true);
            } else { 
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, LocalStateData struct) throws org.apache.thrift.TException {
      ...
      if (struct.serialized_parts != null) {
        oprot.writeFieldBegin(SERIALIZED_PARTS_FIELD_DESC);
        {
          ...
          for (java.util.Map.Entry<java.lang.String, ThriftSerializedObject> _iter708 : struct.serialized_parts.entrySet())
          {
  ...
  private static class LocalStateDataTupleScheme extends org.apache.thrift.scheme.TupleScheme<LocalStateData> {
    ...
    public void write(org.apache.thrift.protocol.TProtocol prot, LocalStateData struct) throws org.apache.thrift.TException {
      org.apache.thrift.protocol.TTupleProtocol oprot = (org.apache.thrift.protocol.TTupleProtocol) prot;
      {
        ...
        for (java.util.Map.Entry<java.lang.String, ThriftSerializedObject> _iter709 : struct.serialized_parts.entrySet())
        {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, LocalStateData struct) throws org.apache.thrift.TException {
      org.apache.thrift.protocol.TTupleProtocol iprot = (org.apache.thrift.protocol.TTupleProtocol) prot;
      {
        ...
        struct.serialized_parts = new java.util.HashMap<java.lang.String,ThriftSerializedObject>(2*_map710.size);
        java.lang.String _key711;
