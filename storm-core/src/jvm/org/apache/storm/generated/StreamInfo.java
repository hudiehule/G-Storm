...
public class StreamInfo implements org.apache.thrift.TBase<StreamInfo, StreamInfo._Fields>, java.io.Serializable, Cloneable, Comparable<StreamInfo> {
  ...
  public java.util.List<java.lang.String> output_fields; // required
  ...
  public int getOutput_fieldsSize() {
    return (this.output_fields == null) ? 0 : this.output_fields.size();
  }

  public java.util.Iterator<java.lang.String> getOutput_fieldsIterator() {
    return (this.output_fields == null) ? null : this.output_fields.iterator();
  }

  public void addToOutput_fields(java.lang.String elem) {
  ...
  public java.util.List<java.lang.String> getOutput_fields() {
    return this.output_fields;
  }

  public StreamInfo setOutput_fields(java.util.List<java.lang.String> output_fields) {
    this.output_fields = output_fields;
    return this;
  }

  public void unsetOutput_fields() {
    this.output_fields = null;
  }

  /** Returns true if field output_fields is set (has been assigned a value) and false otherwise */
  public boolean isSetOutput_fields() {
    return this.output_fields != null;
  }

  public void setOutput_fieldsIsSet(boolean value) {
    if (!value) {
      this.output_fields = null;
    }
  }
  ...
  public StreamInfo setDirect(boolean direct) {
    this.direct = direct;
    setDirectIsSet(true);
    return this;
  }
  ...
  public void setFieldValue(_Fields field, java.lang.Object value) {
    ...
    case OUTPUT_FIELDS:
      if (value == null) {
        ...
        setOutput_fields((java.util.List<java.lang.String>)value);
      }
      break;
  ...
  public boolean equals(StreamInfo that) {
    ...
    boolean this_present_output_fields = true && this.isSetOutput_fields();
    boolean that_present_output_fields = true && that.isSetOutput_fields();
  ...
  public int hashCode() {
    ...
    hashCode = hashCode * 8191 + ((isSetOutput_fields()) ? 131071 : 524287);
    if (isSetOutput_fields())
  ...
  public int compareTo(StreamInfo other) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetOutput_fields()).compareTo(other.isSetOutput_fields());
    if (lastComparison != 0) {
  ...
  public void validate() throws org.apache.thrift.TException {
    ...
    if (output_fields == null) {
      throw new org.apache.thrift.protocol.TProtocolException("Required field 'output_fields' was not present! Struct: " + toString());
    }
    // alas, we cannot check 'direct' because it's a primitive and you chose the non-beans generator.
  ...
  private static class StreamInfoStandardScheme extends org.apache.thrift.scheme.StandardScheme<StreamInfo> {
    ...
    public void read(org.apache.thrift.protocol.TProtocol iprot, StreamInfo struct) throws org.apache.thrift.TException {
        ...
        switch (schemeField.id) {
          case 1: // OUTPUT_FIELDS
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              ...
              struct.setOutput_fieldsIsSet(true);
            } else { 
      ...
      if (!struct.isSetDirect()) {
        throw new org.apache.thrift.protocol.TProtocolException("Required field 'direct' was not found in serialized data! Struct: " + toString());
      }
      struct.validate();
    }
