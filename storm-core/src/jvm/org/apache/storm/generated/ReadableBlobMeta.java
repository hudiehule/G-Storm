...
public class ReadableBlobMeta implements org.apache.thrift.TBase<ReadableBlobMeta, ReadableBlobMeta._Fields>, java.io.Serializable, Cloneable, Comparable<ReadableBlobMeta> {
  ...
  public SettableBlobMeta settable; // required
  ...
  public SettableBlobMeta getSettable() {
    return this.settable;
  }

  public ReadableBlobMeta setSettable(SettableBlobMeta settable) {
    this.settable = settable;
    return this;
  }

  public void unsetSettable() {
    this.settable = null;
  }

  /** Returns true if field settable is set (has been assigned a value) and false otherwise */
  public boolean isSetSettable() {
    return this.settable != null;
  }

  public void setSettableIsSet(boolean value) {
    if (!value) {
      this.settable = null;
    }
  }
  ...
  public ReadableBlobMeta setVersion(long version) {
    this.version = version;
    setVersionIsSet(true);
    return this;
  }
  ...
  public void setFieldValue(_Fields field, java.lang.Object value) {
    ...
    case SETTABLE:
      if (value == null) {
        ...
        setSettable((SettableBlobMeta)value);
      }
      break;
  ...
  public boolean equals(ReadableBlobMeta that) {
    ...
    boolean this_present_settable = true && this.isSetSettable();
    boolean that_present_settable = true && that.isSetSettable();
  ...
  public int hashCode() {
    ...
    hashCode = hashCode * 8191 + ((isSetSettable()) ? 131071 : 524287);
    if (isSetSettable())
  ...
  public int compareTo(ReadableBlobMeta other) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetSettable()).compareTo(other.isSetSettable());
    if (lastComparison != 0) {
  ...
  public void validate() throws org.apache.thrift.TException {
    ...
    if (settable == null) {
      throw new org.apache.thrift.protocol.TProtocolException("Required field 'settable' was not present! Struct: " + toString());
    }
