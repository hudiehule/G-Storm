...
public class TopologyHistoryInfo implements org.apache.thrift.TBase<TopologyHistoryInfo, TopologyHistoryInfo._Fields>, java.io.Serializable, Cloneable, Comparable<TopologyHistoryInfo> {
  ...
  public java.util.List<java.lang.String> topo_ids; // required
  ...
  public java.util.Iterator<java.lang.String> getTopo_idsIterator() {
    return (this.topo_ids == null) ? null : this.topo_ids.iterator();
  }

  public void addToTopo_ids(java.lang.String elem) {
  ...
  public java.util.List<java.lang.String> getTopo_ids() {
    return this.topo_ids;
  }

  public TopologyHistoryInfo setTopo_ids(java.util.List<java.lang.String> topo_ids) {
    this.topo_ids = topo_ids;
    return this;
  }
  ...
  public void setFieldValue(_Fields field, java.lang.Object value) {
    ...
    case TOPO_IDS:
      if (value == null) {
        ...
        setTopo_ids((java.util.List<java.lang.String>)value);
      }
      break;
  ...
  public int hashCode() {
    ...
    hashCode = hashCode * 8191 + ((isSetTopo_ids()) ? 131071 : 524287);
    if (isSetTopo_ids())
  ...
  public int compareTo(TopologyHistoryInfo other) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetTopo_ids()).compareTo(other.isSetTopo_ids());
    if (lastComparison != 0) {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.topo_ids = new java.util.ArrayList<java.lang.String>(_list784.size);
                java.lang.String _elem785;
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TopologyHistoryInfo struct) throws org.apache.thrift.TException {
      ...
      if (struct.topo_ids != null) {
        oprot.writeFieldBegin(TOPO_IDS_FIELD_DESC);
        {
          ...
          for (java.lang.String _iter787 : struct.topo_ids)
          {
      ...
      if (struct.isSetTopo_ids()) {
        {
          ...
          for (java.lang.String _iter788 : struct.topo_ids)
          {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.topo_ids = new java.util.ArrayList<java.lang.String>(_list789.size);
          java.lang.String _elem790;
