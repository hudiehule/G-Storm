...
public class WorkerResources implements org.apache.thrift.TBase<WorkerResources, WorkerResources._Fields>, java.io.Serializable, Cloneable, Comparable<WorkerResources> {
  ...
  public void setFieldValue(_Fields field, java.lang.Object value) {
    ...
    case MEM_ON_HEAP:
      if (value == null) {
        ...
        setMem_on_heap((java.lang.Double)value);
      }
      break;
    ...
    case MEM_OFF_HEAP:
      if (value == null) {
        ...
        setMem_off_heap((java.lang.Double)value);
      }
      break;
  ...
  public int hashCode() {
    ...
    hashCode = hashCode * 8191 + ((isSetMem_on_heap()) ? 131071 : 524287);
    if (isSetMem_on_heap())
      hashCode = hashCode * 8191 + org.apache.thrift.TBaseHelper.hashCode(mem_on_heap);

    hashCode = hashCode * 8191 + ((isSetMem_off_heap()) ? 131071 : 524287);
  ...
  public int compareTo(WorkerResources other) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetMem_on_heap()).compareTo(other.isSetMem_on_heap());
    if (lastComparison != 0) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetMem_off_heap()).compareTo(other.isSetMem_off_heap());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetMem_off_heap()) {
