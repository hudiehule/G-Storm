...
public class HBNodes implements org.apache.thrift.TBase<HBNodes, HBNodes._Fields>, java.io.Serializable, Cloneable, Comparable<HBNodes> {
  ...
  public java.util.List<java.lang.String> pulseIds; // required
  ...
  public java.util.Iterator<java.lang.String> getPulseIdsIterator() {
    return (this.pulseIds == null) ? null : this.pulseIds.iterator();
  }

  public void addToPulseIds(java.lang.String elem) {
  ...
  public java.util.List<java.lang.String> getPulseIds() {
    return this.pulseIds;
  }

  public HBNodes setPulseIds(java.util.List<java.lang.String> pulseIds) {
    this.pulseIds = pulseIds;
    return this;
  }
  ...
  public void setFieldValue(_Fields field, java.lang.Object value) {
    ...
    case PULSE_IDS:
      if (value == null) {
        ...
        setPulseIds((java.util.List<java.lang.String>)value);
      }
      break;
  ...
  public int hashCode() {
    ...
    hashCode = hashCode * 8191 + ((isSetPulseIds()) ? 131071 : 524287);
    if (isSetPulseIds())
  ...
  public int compareTo(HBNodes other) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetPulseIds()).compareTo(other.isSetPulseIds());
    if (lastComparison != 0) {
