...
public class ComponentObject extends org.apache.thrift.TUnion<ComponentObject, ComponentObject._Fields> {
  ...
  public static ComponentObject serialized_java(java.nio.ByteBuffer value) {
    ...
    x.setSerialized_java(value);
    return x;
  }

  public static ComponentObject serialized_java(byte[] value) {
    ComponentObject x = new ComponentObject();
    x.setSerialized_java(java.nio.ByteBuffer.wrap(value.clone()));
    return x;
  }
  ...
  public byte[] getSerialized_java() {
    setSerialized_java(org.apache.thrift.TBaseHelper.rightSize(bufferForSerialized_java()));
    java.nio.ByteBuffer b = bufferForSerialized_java();
    return b == null ? null : b.array();
  }

  public java.nio.ByteBuffer bufferForSerialized_java() {
  ...
  public void setSerialized_java(byte[] value) {
    setSerialized_java(java.nio.ByteBuffer.wrap(value.clone()));
  }

  public void setSerialized_java(java.nio.ByteBuffer value) {
  ...
  public void setShell(ShellComponent value) {
    if (value == null) throw new java.lang.NullPointerException();
    setField_ = _Fields.SHELL;
    value_ = value;
  }

  public JavaObject getJava_object() {
  ...
  public void setJava_object(JavaObject value) {
    if (value == null) throw new java.lang.NullPointerException();
    setField_ = _Fields.JAVA_OBJECT;
    value_ = value;
  }

  public boolean isSetSerialized_java() {
  ...
  public boolean isSetJava_object() {
