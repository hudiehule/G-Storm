...
public class TopologyInfo implements org.apache.thrift.TBase<TopologyInfo, TopologyInfo._Fields>, java.io.Serializable, Cloneable, Comparable<TopologyInfo> {
  ...
  public java.util.List<ExecutorSummary> executors; // required
  public java.lang.String status; // required
  public java.util.Map<java.lang.String,java.util.List<ErrorInfo>> errors; // required
  ...
  public TopologyInfo setId(java.lang.String id) {
    this.id = id;
    return this;
  }
  ...
  public TopologyInfo setName(java.lang.String name) {
    this.name = name;
    return this;
  }
  ...
  public java.util.List<ExecutorSummary> getExecutors() {
    return this.executors;
  }

  public TopologyInfo setExecutors(java.util.List<ExecutorSummary> executors) {
    this.executors = executors;
    return this;
  }
  ...
  public TopologyInfo setStatus(java.lang.String status) {
    this.status = status;
    return this;
  }
  ...
  public void putToErrors(java.lang.String key, java.util.List<ErrorInfo> val) {
    if (this.errors == null) {
  ...
  public java.util.Map<java.lang.String,java.util.List<ErrorInfo>> getErrors() {
    return this.errors;
  }

  public TopologyInfo setErrors(java.util.Map<java.lang.String,java.util.List<ErrorInfo>> errors) {
    this.errors = errors;
    return this;
  }
  ...
  public TopologyInfo setComponent_debug(java.util.Map<java.lang.String,DebugOptions> component_debug) {
  ...
  public TopologyInfo setSched_status(java.lang.String sched_status) {
  ...
  public TopologyInfo setOwner(java.lang.String owner) {
    this.owner = owner;
    return this;
  }
  ...
  public void setFieldValue(_Fields field, java.lang.Object value) {
    ...
    case EXECUTORS:
      if (value == null) {
        ...
        setExecutors((java.util.List<ExecutorSummary>)value);
      }
      break;
    ...
    case ERRORS:
      if (value == null) {
        ...
        setErrors((java.util.Map<java.lang.String,java.util.List<ErrorInfo>>)value);
      }
      break;
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.executors = new java.util.ArrayList<ExecutorSummary>(_list386.size);
                ExecutorSummary _elem387;
                for (int _i388 = 0; _i388 < _list386.size; ++_i388)
                {
                  _elem387 = new ExecutorSummary();
                  _elem387.read(iprot);
                  struct.executors.add(_elem387);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.errors = new java.util.HashMap<java.lang.String,java.util.List<ErrorInfo>>(2*_map389.size);
                java.lang.String _key390;
                java.util.List<ErrorInfo> _val391;
                for (int _i392 = 0; _i392 < _map389.size; ++_i392)
                {
                  _key390 = iprot.readString();
                  {
                    ...
                    _val391 = new java.util.ArrayList<ErrorInfo>(_list393.size);
                    ErrorInfo _elem394;
                    for (int _i395 = 0; _i395 < _list393.size; ++_i395)
                    {
                      _elem394 = new ErrorInfo();
                      _elem394.read(iprot);
                      _val391.add(_elem394);
                    }
                    iprot.readListEnd();
                  }
                  struct.errors.put(_key390, _val391);
                }
                iprot.readMapEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.component_debug = new java.util.HashMap<java.lang.String,DebugOptions>(2*_map396.size);
                java.lang.String _key397;
                DebugOptions _val398;
                for (int _i399 = 0; _i399 < _map396.size; ++_i399)
                {
                  _key397 = iprot.readString();
                  _val398 = new DebugOptions();
                  _val398.read(iprot);
                  struct.component_debug.put(_key397, _val398);
                }
                iprot.readMapEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TopologyInfo struct) throws org.apache.thrift.TException {
      ...
      if (struct.executors != null) {
        oprot.writeFieldBegin(EXECUTORS_FIELD_DESC);
        {
          ...
          for (ExecutorSummary _iter400 : struct.executors)
          {
      ...
      if (struct.errors != null) {
        oprot.writeFieldBegin(ERRORS_FIELD_DESC);
        {
          ...
          for (java.util.Map.Entry<java.lang.String, java.util.List<ErrorInfo>> _iter401 : struct.errors.entrySet())
          {
            oprot.writeString(_iter401.getKey());
            {
              ...
              for (ErrorInfo _iter402 : _iter401.getValue())
              {
      ...
      if (struct.component_debug != null) {
        if (struct.isSetComponent_debug()) {
          oprot.writeFieldBegin(COMPONENT_DEBUG_FIELD_DESC);
          {
            ...
            for (java.util.Map.Entry<java.lang.String, DebugOptions> _iter403 : struct.component_debug.entrySet())
            {
  ...
  private static class TopologyInfoTupleScheme extends org.apache.thrift.scheme.TupleScheme<TopologyInfo> {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, TopologyInfo struct) throws org.apache.thrift.TException {
      ...
      struct.setUptime_secsIsSet(true);
      {
        org.apache.thrift.protocol.TList _list408 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
        struct.executors = new java.util.ArrayList<ExecutorSummary>(_list408.size);
        ExecutorSummary _elem409;
        for (int _i410 = 0; _i410 < _list408.size; ++_i410)
        {
          _elem409 = new ExecutorSummary();
          _elem409.read(iprot);
          struct.executors.add(_elem409);
        }
      }
      struct.setExecutorsIsSet(true);
      struct.status = iprot.readString();
      struct.setStatusIsSet(true);
      {
        org.apache.thrift.protocol.TMap _map411 = new org.apache.thrift.protocol.TMap(org.apache.thrift.protocol.TType.STRING, org.apache.thrift.protocol.TType.LIST, iprot.readI32());
        struct.errors = new java.util.HashMap<java.lang.String,java.util.List<ErrorInfo>>(2*_map411.size);
        java.lang.String _key412;
        java.util.List<ErrorInfo> _val413;
        for (int _i414 = 0; _i414 < _map411.size; ++_i414)
        {
          _key412 = iprot.readString();
          {
            ...
            _val413 = new java.util.ArrayList<ErrorInfo>(_list415.size);
            ErrorInfo _elem416;
            for (int _i417 = 0; _i417 < _list415.size; ++_i417)
            {
              _elem416 = new ErrorInfo();
              _elem416.read(iprot);
              _val413.add(_elem416);
            }
          }
          struct.errors.put(_key412, _val413);
        }
      }
      struct.setErrorsIsSet(true);
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.component_debug = new java.util.HashMap<java.lang.String,DebugOptions>(2*_map418.size);
          java.lang.String _key419;
          DebugOptions _val420;
          for (int _i421 = 0; _i421 < _map418.size; ++_i421)
          {
            _key419 = iprot.readString();
            _val420 = new DebugOptions();
            _val420.read(iprot);
            struct.component_debug.put(_key419, _val420);
          }
        }
        struct.setComponent_debugIsSet(true);
      }
